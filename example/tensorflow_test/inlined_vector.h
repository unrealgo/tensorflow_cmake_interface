...
class InlinedVector {
 public:
  ...
  // https://stackoverflow.com/questions/8456236/how-is-a-vectors-data-aligned  align for SSE and AVX instruction
  static const size_t kSize = ((kSizeUnaligned + 15) / 16) * 16;  // Align to 16 bytes
